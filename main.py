...
class Principal(Screen):
    def __init__(self,**kwargs):
        ...
        self.muestra =MDLabel(text= self.ecuacion ,bold = True, halign = 'right', pos_hint = {'center_y': 0.925} )
        ...
        self.botones.add_widget(Button(text = 'x', bold = True, size_hint = (0.25,0.18), background_color = 'lightblue', on_press = lambda x: self.presionar("*") ))
        self.botones.add_widget(Button(text = '.', bold = True, size_hint = (0.25,0.18), background_color = 'lightblue', on_press = lambda x: self.presionar(".") ))
